                ...
                <div class="col-lg-12">
                    <table width="50%" align="center">
                        <tr>
                            ...
                            <th width="50%" align="left">Symbol</th>
                            <th width="30%" align="left">Market</th>
                        </tr>
                        <%
                            int i = 1;
                        %>
                        <c:forEach items="${stockList}" var="stockList">
                            <tr>
                                ...
                                <td width="50%" align="left">${stockList.symbol}</td>
                                <td width="30%" align="left">${stockList.marketId}</td>
                            </tr>
                        </c:forEach>
                    </table>
                    <br />
                    <a href="<c:url value='/newStock' />">Add New Stock</a>
                    <br />
